...
// 2. Same-origin via Origin header (modern browsers send this on fetch)
if (!$allowed && !empty($_SERVER['HTTP_ORIGIN'])) {
...
// 3. Allow if the constant is defined (when the file is included properly)
if (defined('IN_APP')) {
    $allowed = true;
}
